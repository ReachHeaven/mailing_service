...
from .serializer import MallingSerializer, ClientSerializer, MessageSerializer
...
class MaillingViewSet(viewsets.ModelViewSet):
    ...
    def fullinfo(self, request):
        ...
        def add(request):
            if request.method == 'POST':
                serializer = MallingSerializer(data=request.data)
